...
BASEDIR = Path("../RnE_2022/KLEOPATRA_Light_-_2022-11-04_-_RiLA600_STX-16803_-_2bin/reduced/solved/")
BASEDIR = "../RnE_2022/KLEOPATRA_Light_-_2022-11-04_-_RiLA600_STX-16803_-_2bin/reduced/solved/"
...
#     if not (BASEDIR/reduced_dir).exists():
...
summary = yfu.make_summary(BASEDIR/reduced_dir/solved_dir/"*.fits")
#print(summary)
