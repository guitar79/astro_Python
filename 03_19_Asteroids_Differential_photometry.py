...
_astro_utilities.norm_imshow(axs, hdul[0].data, zscale=True)
...
# Plot all
fig, axs = plt.subplots(1, 1, figsize=(20, 15), sharex=False, sharey=False, gridspec_kw=None)
_astro_utilities.norm_imshow(axs, data, zscale=True)
...
_astro_utilities.norm_imshow(axs, ccd, zscale=True)
...
_astro_utilities.norm_imshow(axins, ccd, zscale=True)
