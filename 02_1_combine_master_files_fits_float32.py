...
# Save file
bias.write('{}{}Master_Bias_{}_f32.fit'.format(base_dr, master_dr, c_method), overwrite =True)
print('{}{}Master_Bias_{}_f32.fit is created'.format(base_dr, master_dr, c_method))
...
print('type(dark0.data)', type(dark0.data),
      ...
      'dark0', dark0)
dark0.write('{}{}Master_Dark0_{}_f32.fit'.format(base_dr, master_dr, c_method), overwrite =True)
print('{}{}Master_Dark0_{}_f32.fit is created'.format(base_dr, master_dr, c_method))

dark = ccd_process(dark0, master_bias=bias) 
dark.data = np.array(dark.data, dtype=np.float32)
...
# Save file
dark.write('{}{}Master_Dark_{}_f32.fit'.format(base_dr, master_dr, c_method), overwrite =True)
print('{}{}Master_Dark_{}_f32.fit is created'.format(base_dr, master_dr, c_method))
...
for chl in['L', 'R', 'G', 'B', 'H', 'S', 'O'] :
    ...
    try : 
        ...
        method=c_method,         # default is average so I specified median.
        unit='adu')
        flat0.data = np.array(flat0.data, dtype=np.float32)   
        print('type(flat0.data)', type(flat0.data), 
            ...
            'flat0', flat0)
        flat0.write('{}{}Master_Flat0_{}_f32.fit'.format(base_dr, master_dr, c_method), 
                overwrite =True)
        print('{}{}Master_Flat0_{}_f32.fit is created'.format(base_dr, master_dr, c_method))
...
# Save file
flat.write('{}{}Master_Flat_{}_f32.fit'.format(base_dr, master_dr, c_method), 
                overwrite =True)
print('{}{}Master_Flat_{}_f32.fit is created'.format(base_dr, master_dr, c_method))
