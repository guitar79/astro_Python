        ...
        if fullname[-4:].lower() == ".txt" \
            ...
            if new_filename[-6:].lower() == "_-.fit" :
                if os.path.exists('{0}{1}_wcs.fit'.format(new_foldername, new_filename[:-6])):
                    ...
                    shutil.copy2(r'{0}'.format(fullname), r'{0}{1}'.format(new_foldername, new_filename))
                    Python_utilities.write_log(log_file, \
                             '{0} is copied to {1}{2}'.format(fullname, new_foldername, new_filename))
                ...
                shutil.copy2(r"{}".format(fullname), r"{}{}".format(new_foldername, new_filename))
                Python_utilities.write_log(log_file, \
                    '{0} is copied to {1}{2}'.format(fullname, new_foldername, new_filename))
